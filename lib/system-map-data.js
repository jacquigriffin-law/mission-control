...
// describes the six internal sections and the safe external surfaces that
...
(function (root) {
  ...
  var DATA = {
    ...
    hubs: [
      ...
      { id: "agents",    label: "Agents",          type: "hub", x: 22, y: 78, desc: "What each agent is doing, blockers and shared work board.", section: "agents" },
      ...
      { id: "documents", label: "Documents",       type: "hub", x: 50, y: 88, desc: "Generated reports, drafts, audits and briefings library.", section: "documents" }
    ],
    ...
    edges: [
      ["mc", "finance"], ["mc", "matters"], ["mc", "agents"],
      ["mc", "memory"],  ["mc", "documents"],
